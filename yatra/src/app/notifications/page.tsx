    ...
    <div className="min-h-screen bg-[#020617] relative overflow-auto">
      ...
      <div className="relative z-10 px-4 py-10">
        <motion.div
          ...
          className="max-w-4xl mx-auto rounded-3xl bg-slate-950/70 backdrop-blur-xl border border-blue-500/20 shadow-[0_0_60px_rgba(37,99,235,0.15)] p-6 sm:p-8"
        >
          {/* Header */}
          ...
          {notifications.length > 0 && (
            <button
              className="mt-8 w-full h-14 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold flex items-center justify-center gap-2"
            >
